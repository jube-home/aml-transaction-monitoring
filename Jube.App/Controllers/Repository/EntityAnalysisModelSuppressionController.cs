    ...
    public class EntityAnalysisModelSuppressionController : Controller
    {
        ...
        public ActionResult<List<EntityAnalysisModelSuppressionDto>> Get()
        {
            try
            {
                ...
                return Ok(mapper.Map<List<EntityAnalysisModelSuppressionDto>>(repository.Get()));
            }
            catch (Exception e)
            {
                log.Error(e);
        ...
        public ActionResult<EntityAnalysisModelSuppressionDto> GetById(int id)
        {
            try
            {
                ...
                return Ok(mapper.Map<EntityAnalysisModelSuppressionDto>(repository.GetById(id)));
            }
            catch (Exception e)
            {
                log.Error(e);
            ...
            [FromBody] EntityAnalysisModelSuppressionDto model)
        {
            try
            {
                ...
                if (results.IsValid)
                {
                    return Ok(repository.Insert(mapper.Map<EntityAnalysisModelSuppression>(model)));
                }
            ...
            [FromBody] EntityAnalysisModelSuppressionDto model)
        {
            try
            {
                ...
                if (results.IsValid)
                {
                    return Ok(repository.Update(mapper.Map<EntityAnalysisModelSuppression>(model)));
                }
