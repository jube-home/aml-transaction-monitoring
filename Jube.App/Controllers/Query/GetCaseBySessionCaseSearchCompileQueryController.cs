...
namespace Jube.App.Controllers.Query
{
    ...
    public class GetCaseBySessionCaseSearchCompileQueryController : Controller
    {
            ...
            IHttpContextAccessor httpContextAccessor, DynamicEnvironment dynamicEnvironment)
        {
            ...
            query = new GetCaseBySessionCaseSearchCompileQuery(dbContext, userName, log, dynamicEnvironment.AppSettings("ReportConnectionString") ?? dbContext.Connection.ConnectionString);
