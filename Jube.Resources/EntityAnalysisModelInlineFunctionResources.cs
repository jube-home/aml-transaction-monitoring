...
{
    public sealed class EntityAnalysisModelInlineFunctionResources
    {
        ...
        public const string ReturnDataTypeIdInvalid = nameof(ReturnDataTypeIdInvalid);
        ...
        public const string EncryptionIdInvalid = nameof(EncryptionIdInvalid);
    }
}