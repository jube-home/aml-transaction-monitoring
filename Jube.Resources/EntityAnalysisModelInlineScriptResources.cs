...
{
    public sealed class EntityAnalysisModelInlineScriptResources
    {
        ...
        public const string EntityAnalysisInlineScriptIdRequired = nameof(EntityAnalysisInlineScriptIdRequired);
        public const string EntityAnalysisInlineScriptIdInvalid = nameof(EntityAnalysisInlineScriptIdInvalid);
    }
}