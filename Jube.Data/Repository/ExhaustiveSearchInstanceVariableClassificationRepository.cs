...
namespace Jube.Data.Repository
{
    ...
    public class ExhaustiveSearchInstanceVariableClassificationRepository(DbContext dbContext) : IGenericRepository
    {
        ...
        {
            return dbContext.InsertWithInt32Identity((ExhaustiveSearchInstanceVariableClassification)arg);
        }
        ...
        {
            return dbContext.ExhaustiveSearchInstanceVariableClassification.Where(w =>
        ...
        {
            dbContext.ExhaustiveSearchInstanceVariableClassification
                .Where(d =>
