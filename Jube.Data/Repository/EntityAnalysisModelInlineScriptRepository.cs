...
namespace Jube.Data.Repository
{
    ...
    public class EntityAnalysisModelInlineScriptRepository
    {
        ...
        {
            return dbContext.EntityAnalysisModelInlineScript.FirstOrDefault(w =>
        ...
        {
            var existing = dbContext.EntityAnalysisModelInlineScript
        ...
        {
            var records = dbContext.EntityAnalysisModelInlineScript
                .Where(d =>
        ...
        {
            dbContext.EntityAnalysisModelInlineScript
                .Where(d =>
